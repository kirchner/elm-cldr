...
toCardinalForm _ floatInfo =
    if
        (floatInfo.absoluteValue == 1)
            || (floatInfo.absoluteValue == 11)
    then
        One
    else if
        (floatInfo.absoluteValue == 2)
            || (floatInfo.absoluteValue == 12)
    then
        Two
    else if
        ((floatInfo.absoluteValue < 3) && (floatInfo.absoluteValue > 10))
            || ((floatInfo.absoluteValue < 13) && (floatInfo.absoluteValue > 19))
    then
        Few
    else
        Other
