...
currencyArabextStandard =
    floatPrinter
        (\float -> s (Number.print arabextNumberSymbols [ '۰', '۱', '۲', '۳', '۴', '۵', '۶', '۷', '۸', '۹' ] currencyArabextStandardNumberFormat float))
...
currencyArabextAccounting =
    floatPrinter
        (\float -> s (Number.print arabextNumberSymbols [ '۰', '۱', '۲', '۳', '۴', '۵', '۶', '۷', '۸', '۹' ] currencyArabextAccountingNumberFormat float))
