    ...
    if
        ((Plural.fractionDigitCount '.' WithTrailingZeros count == 0)
            && ((Plural.integerDigits '.' count == 1)
                    || (Plural.integerDigits '.' count == 2)
                    || (Plural.integerDigits '.' count == 3)
               )
        )
            || (((Plural.fractionDigitCount '.' WithTrailingZeros count == 0)
                    && ((Plural.integerDigits '.' count % 10 /= 4)
                            && (Plural.integerDigits '.' count % 10 /= 6)
                            && (Plural.integerDigits '.' count % 10 /= 9)
                       )
                )
                    || ((Plural.fractionDigitCount '.' WithTrailingZeros count /= 0)
                            && ((Plural.fractionDigits '.' WithTrailingZeros count % 10 /= 4)
                                    && (Plural.fractionDigits '.' WithTrailingZeros count % 10 /= 6)
                                    && (Plural.fractionDigits '.' WithTrailingZeros count % 10 /= 9)
                               )
                       )
               )
    then
