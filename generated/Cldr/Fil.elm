    ...
    if
        ((Plural.fractionDigitCount WithTrailingZeros floatInfo == 0)
            && ((Plural.integerDigits floatInfo == 1)
                    || (Plural.integerDigits floatInfo == 2)
                    || (Plural.integerDigits floatInfo == 3)
               )
        )
            || (((Plural.fractionDigitCount WithTrailingZeros floatInfo == 0)
                    && ((Plural.integerDigits floatInfo % 10 /= 4)
                            && (Plural.integerDigits floatInfo % 10 /= 6)
                            && (Plural.integerDigits floatInfo % 10 /= 9)
                       )
                )
                    || ((Plural.fractionDigitCount WithTrailingZeros floatInfo /= 0)
                            && ((Plural.fractionDigits WithTrailingZeros floatInfo % 10 /= 4)
                                    && (Plural.fractionDigits WithTrailingZeros floatInfo % 10 /= 6)
                                    && (Plural.fractionDigits WithTrailingZeros floatInfo % 10 /= 9)
                               )
                       )
               )
    then
