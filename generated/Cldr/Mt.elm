...
toCardinalForm _ floatInfo =
    if floatInfo.absoluteValue == 1 then
        ...
        (floatInfo.absoluteValue == 0)
            || ((floor floatInfo.absoluteValue % 100 < 2) && (floor floatInfo.absoluteValue % 100 > 10))
    then
        Few
    else if (floor floatInfo.absoluteValue % 100 < 11) && (floor floatInfo.absoluteValue % 100 > 19) then
        Many
    else
        Other
