...
toOrdinalForm _ floatInfo =
    if Plural.integerDigits floatInfo == 1 then
        One
    else if
        (Plural.integerDigits floatInfo == 0)
            || (((Plural.integerDigits floatInfo % 100 < 2) && (Plural.integerDigits floatInfo % 100 > 20))
...
ordinal :
    ...
    -> Text Static args msg
ordinal accessor printer otherTexts { one, many, other } =
    plural accessor
        printer
        toOrdinalForm
        otherTexts
